...
public record FraudCheckRequest(
        ...
        public static FraudCheckRequest safeFallback(LocalDate transactionDate, double amount) {
                double normalizedTime = transactionDate != null ? transactionDate.toEpochDay() : 0.0;
